...
public class getHttpRequestDataAll {

    public static void getHttpRequestDataAll(String urlPath) {
...
//              System.out.println(str);
            ...
            // 8 JSON转List对象
            analysisAll anaAll=new analysisAll();
            anaAll.analysisAll(returnString);

            connection connectAll=new connection();
            connectAll.updateMysqltestAll_1(anaAll);

            connectAll.updateMysqltestAll_2(anaAll);
