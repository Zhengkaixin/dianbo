...
public class getHttpRequestDataBase {
    public static void getHttpRequestDataBase(String urlPath) {
...
//              System.out.println(str);
            ...
            // 8 JSON转List对象
            analysisBase anaBase=new analysisBase();
            anaBase.analysisBase(returnString);

            connection connectBase=new connection();
            connectBase.updateMysqltestBase(anaBase);
